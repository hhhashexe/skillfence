...
const CONTEXT_ALLOWLIST = {
  ...
  // exec() in regex/database context is not shell execution
  'exec\\s*\\(': { allowIn: /regex|regexp|\.exec\(|resolvable|match|better-sqlite|sqlite3|\.db\.|database|sequelize|knex|prisma|typeorm/i, reason: 'Database/RegExp .exec(), not shell execution' },
